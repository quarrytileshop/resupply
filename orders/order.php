    ...
    <div class="card-body">
        <form method="POST" action="<?= BASE_URL ?>orders/save_order.php">
            ...
            <div class="btn-group w-100 mb-4" role="group">
                <a href="?type=general" class="btn btn-outline-primary <?= $order_type==='general'?'active':'' ?>">General Tile</a>
                <a href="?type=propane" class="btn btn-outline-primary <?= $order_type==='propane'?'active':'' ?>">Propane</a>
                <a href="?type=paint" class="btn btn-outline-primary <?= $order_type==='paint'?'active':'' ?>">Paint</a>
                <a href="?type=checkbox" class="btn btn-outline-primary <?= $order_type==='checkbox'?'active':'' ?>">Checkbox List</a>
            </div>

            <div class="mb-4">
                <label class="form-label">Order Items</label>
                <textarea name="items" class="form-control" rows="10" placeholder="Enter items here..."></textarea>
            </div>
