<?php
// propane_order.php – Modified 2026-05-08 – Lines: 160
...
<body class="bg-light">
    ...
    <div class="container mt-4">
        <h1>Propane Order</h1>
        <p class="text-muted">Quick form for tank exchanges and new fills.</p>
            ...
            <div class="card-body">
                <form id="propaneForm">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" rows="4" placeholder="e.g. Need delivery by Friday..."></textarea>
                    </div>
    ...
    function submitPropaneOrder() {
        if (confirm("Send this propane order now?")) {
            ...
            // Future: AJAX to process + rocket animation
