...
<?php
/**
 * resupply - Admin Pre-Register Page (inside admin/ folder)
 * Updated for new folder structure (May 14, 2026)
 * All includes use ../includes/ and asset paths updated
 */

$page_title = "Pre-Register User - Resupply Rocket";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($first_name && $last_name && $email) {
        // Generate temporary reset token so user can set password
        ...
        $stmt = $pdo->prepare("INSERT INTO users 
            ...
            VALUES 
            (:first_name, :last_name, :email, :username, :org_id, 'pending', :token, :expires, NOW())");
        ...
        if ($success) {
            ...
            $_SESSION['message'] = "User pre-registered successfully! They can set their password using this link: <br><strong>" . htmlspecialchars($reset_link) . "</strong>";
            header("Location: admin_pre_register.php");
            exit;
        } else {
            $error = "Failed to pre-register user. Please try again.";
        }
    } else {
...
<div class="container mt-4">
    <h1 class="mb-4">Pre-Register New User</h1>
    <p class="text-muted">Create a user account and send them a password setup link.</p>
        ...
        <div class="card-body">
            <form method="post">
                ...
                <div class="mt-4 text-center">
                    <button type="submit" class="btn btn-success btn-lg px-5">Pre-Register User</button>
