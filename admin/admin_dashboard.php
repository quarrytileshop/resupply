<?php
/**
 * resupply - Admin Dashboard (Super Admin)
 * Updated for new folder structure (May 14, 2026)
 * Clean layout - no duplicate containers
 */
...
<div class="row g-4">
    <div class="col-md-6 col-lg-4">
        <div class="card h-100 shadow-sm">
            <div class="card-header"><h5 class="mb-0">Management</h5></div>
            <div class="card-body">
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card h-100 shadow-sm">
            <div class="card-header"><h5 class="mb-0">Vendor Tools</h5></div>
            <div class="card-body">
                <div class="d-grid gap-2">
    ...
    <div class="col-md-6 col-lg-4">
        <div class="card h-100 shadow-sm">
            <div class="card-header"><h5 class="mb-0">Utilities</h5></div>
            <div class="card-body">
                <div class="d-grid gap-2">
